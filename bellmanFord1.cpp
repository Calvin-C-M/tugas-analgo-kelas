...
int main() {
    // int V=6; // Ganti sesuai value yang ada di dataset
    // int E=8; // Ganti sesuai value yang ada di dataset
    int V=0;
    int E=0;
    ...
    // addEdge(graph->edge[0],0,1,10);
    // addEdge(graph->edge[1],1,3,2);
    // addEdge(graph->edge[2],2,1,1);
    // addEdge(graph->edge[3],3,2,-2);
    // addEdge(graph->edge[4],4,1,-4);
    // addEdge(graph->edge[5],4,3,-1);
    // addEdge(graph->edge[6],0,5,8);
    // addEdge(graph->edge[7],5,4,1);
